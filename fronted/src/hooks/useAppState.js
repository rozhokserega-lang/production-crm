...
export function useAppState({ auth }) {
  ...
  // Requires auth: RPC needs auth.uid() for created_by (see web_seed_furniture_strap_template).
  useEffect(() => {
    if (!furnitureWorkbook || !furnitureActiveSheet || !authUser?.id) return;
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [furnitureWorkbook, furnitureActiveSheet, authUser?.id]);
  ...
  return {
    ...
    dialogs: {
      consume: {
        ...
        setOpen: setConsumeDialogOpen,
        editMode: consumeEditMode,
        setEditMode: setConsumeEditMode,
        data: consumeDialogData,
        setData: setConsumeDialogData,
        material: consumeMaterial,
        setMaterial: setConsumeMaterial,
        qty: consumeQty,
        setQty: setConsumeQty,
        saving: consumeSaving,
        setSaving: setConsumeSaving,
        error: consumeError,
        setError: setConsumeError,
        loading: consumeLoading,
        setLoading: setConsumeLoading,
      },
      strap: {
        open: strapDialogOpen,
        setOpen: setStrapDialogOpen,
        targetProduct: strapTargetProduct,
        setTargetProduct: setStrapTargetProduct,
        planWeek: strapPlanWeek,
        setPlanWeek: setStrapPlanWeek,
        draft: strapDraft,
        setDraft: setStrapDraft,
      },
      plan: {
        open: planDialogOpen,
      ...
      strapDone: {
        ...
        meta: strapDoneDialogMeta,
        qtyInput: strapDoneQtyInput,
        setQtyInput: setStrapDoneQtyInput,
        error: strapDoneError,
        saving: strapDoneSaving,
