...
describe("normalizeOrder", () => {
  ...
  it("returns the input as-is for null/undefined", () => {
    expect(normalizeOrder(null as unknown as Record<string, unknown>)).toBeNull();
    expect(normalizeOrder(undefined as unknown as Record<string, unknown>)).toBeUndefined();
  });
...
describe("formatDateTimeRu", () => {
  it("returns '-' for empty input", () => {
    ...
    expect(formatDateTimeRu(null as unknown as string)).toBe("-");
    expect(formatDateTimeRu(undefined as unknown as string)).toBe("-");
  });
