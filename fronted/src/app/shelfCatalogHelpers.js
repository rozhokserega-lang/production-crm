...
export const DEFAULT_GX_SHELF_CATALOG = [
  ...
  { primary: { code: "GXss1-600hBVO", name: "Система хранения. 1 секция 600 мм. 3 полки с вешалкой. Чёрная. Дуб вотан" }, pairs: [{ text: "полка 587x340", qty: 2 }, { text: "полка 587x330", qty: 1 }] },
  { primary: { code: "GXss1-600hWOS", name: "Система хранения. 1 секция 600 мм. 3 полки с вешалкой. Белая. Дуб сонома" }, pairs: [{ text: "полка 587x340", qty: 2 }, { text: "полка 587x330", qty: 1 }] },
  { primary: { code: "GXss1-400BVO", name: "Система хранения. 1 секция 400 мм. 5 полок. Чёрная. Дуб вотан" }, pairs: [{ text: "полка 387x340", qty: 5 }] },
  { primary: { code: "GXss1-400WOS", name: "Система хранения. 1 секция 400 мм. 5 полок. Белая. Дуб сонома" }, pairs: [{ text: "полка 387x340", qty: 5 }] },
