...
const RPC_MAP = {
  ...
  webGetCuttingCatalogKits: "web_get_cutting_catalog_kits",
  webUpsertCuttingCatalogKit: "web_upsert_cutting_catalog_kit",
  webDeleteCuttingCatalogKit: "web_delete_cutting_catalog_kit",
  webGetGxShelfCatalog: "web_get_gx_shelf_catalog",
  webUpsertGxShelfCatalogItem: "web_upsert_gx_shelf_catalog_item",
  webDeleteGxShelfCatalogItem: "web_delete_gx_shelf_catalog_item",
  ...
  webCompleteReplacementForWorkshopOrder: "web_complete_replacement_for_workshop_order",
  ...
  webSeedFurnitureStrapTemplate: "web_seed_furniture_strap_template",
...
function buildRpcPayload(action, payload = {}) {
  ...
  if (action === "webAcceptReplacementOrderPackaging") {
    return {
      ...
      p_workshop_order_id: String(payload.p_workshop_order_id || payload.workshopOrderId || "").trim(),
    };
  }
  if (action === "webCompleteReplacementForWorkshopOrder") {
    return {
      p_workshop_order_id: String(payload.p_workshop_order_id || payload.orderId || "").trim(),
    };
  }
  ...
  if (action === "webSeedFurnitureStrapTemplate") {
    return {
