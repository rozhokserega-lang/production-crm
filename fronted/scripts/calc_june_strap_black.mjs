...
const DETAIL_CATALOG = [
  ...
  { product_name: "Авелла Лайт", detail_name_pattern: "%обвязка%1158_50%", is_active: true },
  { product_name: "Авелла Лайт", detail_name_pattern: "%обвязка%600_50%", is_active: true },
  { product_name: "Авелла", detail_name_pattern: "%обвязка%1158_50%", is_active: true },
  { product_name: "Авелла", detail_name_pattern: "%обвязка%600_50%", is_active: true },
