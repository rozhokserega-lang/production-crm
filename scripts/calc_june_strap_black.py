...
STRAP_TYPE_CODES = {
    ...
    "1158_56", "600_56", "502_80", "544_80", "288_80", "520_80", "396_305", "153x320",
}
...
STRAP_DISPLAY = {
    ...
    "1158_56": "Обвязка (1158_56)",
    "600_56": "Обвязка (600_56)",
...
DETAIL_CATALOG = [
    ...
    ("Авелла Лайт", "%обвязка%1158_56%"),
    ("Авелла Лайт", "%обвязка%600_56%"),
    ("Авелла", "%обвязка%1158_56%"),
    ("Авелла", "%обвязка%600_56%"),
...
LINE_RULES = {
    ...
    "avella_lite": {"1158_56": 2, "600_56": 2},
}
