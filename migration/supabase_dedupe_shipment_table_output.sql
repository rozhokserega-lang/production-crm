...
as $$
  with src as (
    ...
    left join public.materials_stock ms
      on public.web_normalize_material_name(ms.material) = public.web_normalize_material_name(coalesce(nullif(spc.material, ''), icm.color_name, ''))
